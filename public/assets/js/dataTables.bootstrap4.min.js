...
!function (t) {
    ...
    return x.extend(!0, s.defaults, {
        ...
        function u(e, a) {
            for (var t, n, r = function (e) {
            ...
            }, s = 0, o = a.length; s < o; s++) if (t = a[s], Array.isArray(t)) u(e, t); else {
                switch (f = p = "", t) {
                    case"ellipsis":
                        p = "&#x2026;", f = "disabled";
                        break;
                ...
                p && (n = -1 !== f.indexOf("disabled"), n = x("<li>", {
                    ...
                    class: "page-link"
                }).html(p)).appendTo(e), i.oApi._fnBindAction(n, {action: t}, r))
            }
        }

        var p, f, t, b = new s.Api(i), m = i.oClasses, g = i.oLanguage.oPaginate, w = i.oLanguage.oAria.paginate || {};
        try {
